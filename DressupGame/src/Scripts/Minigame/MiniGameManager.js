...
export class MiniGameManager {
    ...
    setUpGame(scene) {
        ...
        // const rectangle1 = scene.add.rectangle(scene.scale.width / 1.7, scene.scale.height / 2.4, 50, 50, 0x000000, 1).setDepth(100).setVisible(false);
        // const rectangle2 = scene.add.rectangle(scene.scale.width / 2.2, scene.scale.height / 2.2, 50, 50, 0x000000, 1).setDepth(100).setVisible(false);
        // const rectangle3 = scene.add.rectangle(scene.scale.width / 1.7, scene.scale.height / 3.2, 50, 50, 0x000000, 1).setDepth(100).setVisible(false);
        // const rectangle4 = scene.add.rectangle(scene.scale.width / 2.2, scene.scale.height / 3, 50, 50, 0x000000, 1).setDepth(100).setVisible(false);
        // const rectangle5 = scene.add.image(scene.scale.width / 2.75, scene.scale.height / 2, 'fingerCursor').setDepth(100).setScale(0.3)
        // const testTimeline = scene.add.timeline();
        // testTimeline.on('MOVE_RECTANGLE1', () => {
        //     scene.tweens.add({
        //         targets: rectangle5,
        //         x: rectangle1.x,
        //         y: rectangle1.y / 0.9,
        ...
        // testTimeline.on('MOVE_RECTANGLE2', () => {
        //     scene.tweens.add({
        //         targets: rectangle5,
        //         x: rectangle2.x,
        //         y: rectangle2.y / 0.9,
        ...
        // testTimeline.on('MOVE_RECTANGLE3', () => {
        //     scene.tweens.add({
        //         targets: rectangle5,
        //         x: rectangle3.x,
        //         y: rectangle3.y / 0.9,
        ...
        // testTimeline.on('MOVE_RECTANGLE4', () => {
        //     scene.tweens.add({
        //         targets: rectangle5,
        //         x: rectangle4.x,
        //         y: rectangle4.y / 0.9,
        ...
        //     {
        //         at: 0,
        //         event: 'MOVE_RECTANGLE4'
        //     },
        //     {
        //         at: 500,
        //         event: 'MOVE_RECTANGLE3'
        //     },
        //     {
        //         at: 1000,
        //         event: 'MOVE_RECTANGLE2'
        //     },
        //     {
        //         at: 1500,
        //         event: 'MOVE_RECTANGLE1'
        //     },
        //     {
        //         at: 2000,
        //         event: 'MOVE_RECTANGLE4'
