...
const makeUpData = [
    ...
    new MakeUp('Blush 7', 'Blush', 'blushnose', 'buttonIcon2', { atlas: 'makeup1_spritesheet', frame: 'mc_blush red nose.png' }, true),
    new MakeUp('Blush 8', 'Blush', 'blushround', 'buttonIcon2', { atlas: 'makeup1_spritesheet', frame: 'mc_blush round.png' }, true),
    ...
    new MakeUp('Eyebrows 4', 'Eyebrows', { atlas: 'eyebrow_spritesheet', frame: 'mc_eb 4_normal.png' }, 'buttonIcon2', { atlas: 'makeup1_spritesheet', frame: 'mc_eb 4.png' }, true),
    new MakeUp('Eyebrows 5', 'Eyebrows', { atlas: 'eyebrow_spritesheet', frame: 'mc_eb 5_normal.png' }, 'buttonIcon2', { atlas: 'makeup1_spritesheet', frame: 'mc_eb 5.png' }, true),
    ...
    new MakeUp('Eyelashes4', 'Eyelashes', { atlas: 'eyelashes_spritesheet', frame: 'mc_el 4_normal.png' }, 'buttonIcon2', { atlas: 'makeup1_spritesheet', frame: 'mc_el 4.png' }, true),
    new MakeUp('Eyelashes5', 'Eyelashes', { atlas: 'eyelashes_spritesheet', frame: 'mc_el 5_normal.png' }, 'buttonIcon2', { atlas: 'makeup1_spritesheet', frame: 'mc_el 5.png' }, true),
    ...
    new MakeUp('Eyeliner4', 'Eyeliner', 'eyelinernormal4', 'buttonIcon2', { atlas: 'makeup1_spritesheet', frame: 'mc_er 4.png' }, true),
    new MakeUp('Eyeliner5', 'Eyeliner', 'eyelinernormal5', 'buttonIcon2', { atlas: 'makeup1_spritesheet', frame: 'mc_er 5.png' }, true),
    ...
    new MakeUp('EyeShadowPeach', 'Eyeshadow', 'eyeshadownormalpeach', 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_peach.png' }, true),
    new MakeUp('EyeShadowPink', 'Eyeshadow', 'eyeshadownormalpink', 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_pink.png' }, true),
    new MakeUp('EyeShadowPurple', 'Eyeshadow', 'eyeshadownormalpurple', 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_purple.png' }, true),
    ...
    new MakeUp('LipsPink', 'Lips', 'lipnormalpink', 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_lips pink.png' }, true),
    new MakeUp('LipsRed', 'Lips', 'lipnormalred', 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_lips red.png' }, true),
    new MakeUp('LipsWine', 'Lips', 'lipnormalwine', 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_lips wine.png' }, true),
    ...
    new MakeUp('PupilPink', 'Pupil', { atlas: 'pupil_spritesheet', frame: 'mc_pupil pink_normal.png' }, 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_pupil pink.png' }, true),
    new MakeUp('PupilRed', 'Pupil', { atlas: 'pupil_spritesheet', frame: 'mc_pupil red_normal.png' }, 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_pupil red.png' }, true),
    new MakeUp('PupilYellow', 'Pupil', { atlas: 'pupil_spritesheet', frame: 'mc_pupil yellow_normal.png' }, 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_pupil yellow.png' }, true),
    ...
    new MakeUp('StickerstarPink', 'Sticker', { atlas: 'sticker_spritesheet', frame: 'mc_sticker manik pink_star.png' }, 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_sticker manik pink_star.png' }, true),
    new MakeUp('StickerstarPurple', 'Sticker', { atlas: 'sticker_spritesheet', frame: 'mc_sticker manik purple_star.png' }, 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_sticker manik purple_star.png' }, true),
    new MakeUp('StickerstarRed', 'Sticker', { atlas: 'sticker_spritesheet', frame: 'mc_sticker manik red_star.png' }, 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_sticker manik red_star.png' }, true),
    new MakeUp('StickerstarYellow', 'Sticker', { atlas: 'sticker_spritesheet', frame: 'mc_sticker manik yellow_star.png' }, 'buttonIcon2', { atlas: 'makeup2_spritesheet', frame: 'mc_sticker manik yellow_star.png' }, true),
    ...
    new MakeUp('01Pink', 'Hair', { front: { atlas: 'hair_front_01', frame: 'hair_01_pink_F_out.png' }, back: { atlas: 'hair_back_01', frame: 'hair_01_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_01_pink.png' }), true,
    ...
    new MakeUp('02Pink', 'Hair', { front: { atlas: 'hair_front_01', frame: 'hair_02_pink_F_out.png' }, back: { atlas: 'hair_back_01', frame: 'hair_02_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_02_pink.png' }, true),
    ...
    new MakeUp('03Pink', 'Hair', { front: { atlas: 'hair_front_01', frame: 'hair_03_pink_F_out.png' }, back: { atlas: 'hair_back_01', frame: 'hair_03_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_03_pink.png' }, true),
    ...
    new MakeUp('04Pink', 'Hair', { front: { atlas: 'hair_front_01', frame: 'hair_04_pink_F_out.png' }, back: { atlas: 'hair_back_01', frame: 'hair_04_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_04_pink.png' }, true),
    ...
    new MakeUp('05Pink', 'Hair', { front: { atlas: 'hair_front_02', frame: 'hair_05_pink_F_out.png' }, back: { atlas: 'hair_back_02', frame: 'hair_05_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_05_pink.png' }, true),
    ...
    new MakeUp('06Pink', 'Hair', { front: { atlas: 'hair_front_02', frame: 'hair_06_pink_F_out.png' }, back: { atlas: 'hair_back_02', frame: 'hair_06_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_06_pink.png' }, true),
    ...
    new MakeUp('07Pink', 'Hair', { front: { atlas: 'hair_front_02', frame: 'hair_07_pink_F_out.png' }, back: { atlas: 'hair_back_02', frame: 'hair_07_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_07_pink.png' }, true),
    ...
    new MakeUp('08Pink', 'Hair', { front: { atlas: 'hair_front_02', frame: 'hair_08_pink_F_out.png' }, back: { atlas: 'hair_back_02', frame: 'hair_08_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_08_pink.png' }, true),
    ...
    new MakeUp('09Pink', 'Hair', { front: { atlas: 'hair_front_03', frame: 'hair_09_pink_F_out.png' }, back: { atlas: 'hair_back_03', frame: 'hair_09_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_09_pink.png' }, true),
    ...
    new MakeUp('10Violet', 'Hair', { front: { atlas: 'hair_front_03', frame: 'hair_10_violet_F_out.png' }, back: { atlas: 'hair_back_03', frame: 'hair_10_violet_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_10_violet.png' }, true),
    ...
    new MakeUp('11Pink', 'Hair', { front: { atlas: 'hair_front_03', frame: 'hair_11_pink_F_out.png' }, back: { atlas: 'hair_back_03', frame: 'hair_11_pink_B_out.png' } }, 'buttonIcon2', { atlas: 'hair_spritesheet', frame: 'hair_11_pink.png' }, true),
];
