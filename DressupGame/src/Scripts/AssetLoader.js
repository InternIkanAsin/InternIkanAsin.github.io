export default class AssetLoader {
  ...
  static loadUIAssets(scene) {
    ...
    scene.load.image('IDressIcon', 'Asset/UI/Undress_All_Icon.png');
    ...
    scene.load.image('sidePanelDividerPortrait', "Asset/UI/New/Wardrobe_Divider_portrait.png");
